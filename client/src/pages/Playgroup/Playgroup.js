              ...
              <Panel.Heading style={{ padding: "10px 0px 0px" }}>
                ...
                >
                  <NavDropdown
                    ...
                    id="playgroupSelect"
                  >
                    {this.state.joinedGroups.map((group, i) => (
                      <MenuItem
                        active={
                          this.state.group && this.state.group._id === group._id
                        }
                        key={group._id}
                        eventKey={i}
                      >
                  ...
                  <NavItem eventKey="search">Find Playgroups</NavItem>
                  <NavItem eventKey="new">Create a Playgroup</NavItem>
                </Nav>
              </Panel.Heading>

              {this.state.display === "group" && (
                <PlaygroupChat
